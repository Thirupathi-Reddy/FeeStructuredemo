...
<c:url var="updatefeedetails"
	value="/Student/updateStudent.html" />
	 
	<form:form action="${updatefeedetails}" method="post" id="updateform" name="updatefeeform"
	...
	<table align="center"  WIDTH="50%" cellspacing="5" cellpadding="5">
									...
									<tr>
										...
										<td><input type="text"  class="textbox1" name="firstname" id="firstname"  value="${received.firstname}"/> </td>
									</tr>
									<tr>
									
										<td><label for="simple-input"><font size="3"><b>Last Name</b></font><font color=red >*</font></label></td>
										<td><input type="text" required class="textbox1" name="lastname" id="lastname" value="${received.lastname}"/></td>
									</tr>
									<tr>
									
										<td><label for="simple-input"><font size="3"><b>Email</b></font><font color=red >*</font></label></td>
										<td><input type="text" required class="textbox1" name="email" id="email" value=${received.email} /></td>
									</tr>
									
									<tr>
										<td><label for="dropdown-actions"><font size="3"><b>Academic Year</b></font></label></td>
	
										<td><select class="selectbox" id="year" name="year"><option value="${received.year}">${received.year}</option>
		 ...
		 <tr>
          ...
          <td><select class="selectbox" id="standard" name="standard" onchange="messageReveal()">
           <option value="${received.standard}">${received.standard}</option>
          ...
          <option value="${received.section}">${received.section}</option>
        ...
        <td><label for="simple-input"><font size="3"><b>Date Of Birth</b></font><font color=red >*</font></label></td>
		 <td><input type="date" required class="textbox1" name="dateofbirth" id="dateofbirth" VALUE="${received.dateofbirth}" /></td>
         </tr>
         <tr>
          ...
          <option VALUE="${received.typeofstudent}">${received.typeofstudent}</option>
       ...
       <DIV id = "FSH" style="display:none"> 
		 ...
		 <td><input type="text"  class="textbox1" name="totaltfee" id="totaltfee"  VALUE="${received.totaltfee}"  onkeyup="hostlerfeecal()"/></td>
         </tr>
							
			<tr >
         <td><label for="simple-input"><font size="3"><b>Paid Tuition Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totaltpaidfee" id="totaltpaidfee" VALUE="${received.totaltpaidfee}"  onkeyup="hostlerfeecal()"/></td>
         </tr>
         <tr>
         <td><label for="simple-input"><font size="3"><b>Due Tuition Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totaltduefee" id="totaltduefee" VALUE="${received.totaltduefee}" /></td>
         </tr>
         <tr >
         
         <tr >
         <td><label for="simple-input"><font size="3"><b>Total Computer Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totalcfee" id="totalcfee"  VALUE="${received.totalcfee}" onkeyup="hostlerfeecal()" /></td>
         </tr>
           <tr >
         <td><label for="simple-input"><font size="3"><b>Paid Computer Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totalcpaidfee" id="totalcpaidfee"  VALUE="${received.totalcpaidfee}"onkeyup="hostlerfeecal()" /></td>
         </tr>
           <tr >
         <td><label for="simple-input"><font size="3"><b>Due Computer Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totalcduefee" id="totalcduefee" VALUE="${received.totalcduefee}" /></td>
         </tr> 
         <tr >
         <td><label for="simple-input"><font size="3"><b>Total Dhobi Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totaldfee" id="totaldfee" VALUE="${received.totaldfee}"  onkeyup="hostlerfeecal()"/></td>
         </tr>
            <tr >
         <td><label for="simple-input"><font size="3"><b>Paid Dhobi Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totaldpaidfee" id="totaldpaidfee" VALUE="${received.totaldpaidfee}"  onkeyup="hostlerfeecal()"/></td>
         </tr>
           <tr >
         <td><label for="simple-input"><font size="3"><b>Due Dhobi Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totaldduefee" id="totaldduefee" VALUE="${received.totaldduefee}" /></td>
         </tr> 
      
        <tr >
          <td><label for="dropdown-actions"><font size="3"><b>Status</b></font></label></td>
          <td><select class="selectbox" id="status" name="status">
          <option VALUE="${received.status}">${received.status}</option>
      ...
      <!--  ------------------- FEE STRUCTURE FOR DAYSCHOLER----------------------    -->      
         ...
         <TABLE align="center" width="50%" cellspacing="5" cellpadding="5">
          <TR >
         <td><label for="simple-input"><font size="3"><b>Total Tuition Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"  class="textbox1" name="totaltdfee" id="totaltdfee" VALUE="${received.totaltdfee}" onkeyup="dayscholerfeecal()" /></td>
         </tr>
									
		 	<tr >
         <td><label for="simple-input"><font size="3"><b>Paid Tuition Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totaltdpfee" id="totaltdpfee" VALUE="${received.totaltdpfee}" onkeyup="dayscholerfeecal()" /></td>
         </tr>
         <tr>
         <td><label for="simple-input"><font size="3"><b>Due Tuition Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="totaltddfee" id="totaltddfee" VALUE="${received.totaltddfee}" /></td>
         </tr>
         <tr >
       
         <tr >
         <td><label for="simple-input"><font size="3"><b>Total Computer Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="date"   class="textbox1" name="totalctfee" id="totalctfee" VALUE="${received.totalctfee}" onkeyup="dayscholerfeecal()"/></td>
         </tr>
          <tr >
         <td><label for="simple-input"><font size="3"><b>Paid Computer Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="date"   class="textbox1" name="totalcpfee" id="totalcpfee" VALUE="${received.totalcpfee}" onkeyup="dayscholerfeecal()" /></td>
         </tr>
            <tr >
         <td><label for="simple-input"><font size="3"><b>Due Computer Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="date"   class="textbox1" name="totalcdfee" id="totalcdfee" VALUE="${received.totalcdfee}" /></td>
         </tr>
        ...
        <tr>
										...
										<option VALUE="${received.vanStop}">${received.vanStop}</option>
		 ...
		 <td><input type="text"   class="textbox1" name="totalvanfee" id="totalvanfee" VALUE="${received.totalvanfee}" onkeyup="sumvanfee()" /></td>
         </tr>
         <tr>
         <td><label for="simple-input"><font size="3"><b> Van Fee TERM-1</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="vanterm1" id="vanterm1"  VALUE="${received.vanterm1}" onkeyup="sumvanfee()" /></td>
         </tr>
         <tr>
         <td><label for="simple-input"><font size="3"><b> Van Fee TERM-2</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="vanterm2" id="vanterm2" VALUE="${received.vanterm2}" onkeyup="sumvanfee()" /></td>
         </tr>
         <tr>
         <td><label for="simple-input"><font size="3"><b>Van Fee TERM-3</b></font><font color=red >*</font></label></td>
		 <td><input type="text"   class="textbox1" name="vanterm3" id="vanterm3" VALUE="${received.vanterm3}" onkeyup="sumvanfee()" /></td>
         </tr>
           <tr >
         <td><label for="simple-input"><font size="3"><b>Paid Van Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="date"   class="textbox1" name="vanpaidfee" id="vanpaidfee" VALUE="${received.vanpaidfee}" onkeyup="sumvanfee()"/></td>
         </tr>
           <tr >
         <td><label for="simple-input"><font size="3"><b>Due Van Fee</b></font><font color=red >*</font></label></td>
		 <td><input type="date"   class="textbox1" name="vanduefee" id="vanduefee" VALUE="${received.vanduefee}"  /></td>
         </tr>
         <tr >
          <td><label for="dropdown-actions"><font size="3"><b>Status</b></font></label></td>
          <td><select class="selectbox" id="status1" name="status1">
          <option value="status1">${received.status1}</option>
           <option value="Due">Due</option>
           <option value="NoDue">NoDue</option></select> 
         </tr> </TABLE></div>  
         ...
         <table align="center" width="50%" cellspacing="5" cellpadding="5" >       
        <tr><td></td><td></td>
	<td align="center" width="50%" ><input type="submit" class="myButton" value="Update" onclick="popupwindow()"  /></td>
							<td></td></tr></table>
