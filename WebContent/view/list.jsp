	...
	<tbody>
		<c:forEach items="${studentList}" var="item">
			...
			<tr style="cursor: pointer" onmouseover="this.background='#C0C0C0'"">
				...
				<td><c:out value="${item.paidDate}"></c:out></td>
				<td><c:out value="${item.dueAmount}"></c:out></td> --%>
				<td><c:out value="${item.status}"></c:out></td>
				 <td><a href="updatedetails.html?studentid=${item.studentid}"><font color="red">Update</font></a></td>
    <td><a href="viewdetails.html?typeofstudent=${item.typeofstudent}&studentid=${item.studentid}">View</a></td>
				</tr> 
